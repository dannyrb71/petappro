...
| BIZ-5 | Open Apple Developer acct (Organization, $99) | Danny | DOING | **Business Apple ID created 2026-07-08** on `developer@base509.com` (throttle cleared; separate from personal ID). **2FA enabled** (2 trusted numbers). **Next: enroll in the Developer Program as Organization ($99)** at developer.apple.com/enroll — **HOLD until D&B case #34660335 confirms the D-U-N-S record is corrected + active** (Apple verifies D-U-N-S at enrollment; stale "BASE509, LLC 2019" record could fail it). |
